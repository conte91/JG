...
class ColorGradientPyramidFull : public QuantizedPyramid
{
public:
  ColorGradientPyramidFull(const Mat& src, const Mat& mask,
...
ColorGradientPyramidFull::ColorGradientPyramidFull(const Mat& _src, const Mat& _mask,
...
void ColorGradientPyramidFull::update()
{
  quantizedOrientations(src, magnitude, angle, weak_threshold);
}

void ColorGradientPyramidFull::pyrDown()
{
...
void ColorGradientPyramidFull::quantize(Mat& dst) const
{
  dst = Mat::zeros(angle.size(), CV_8U);
  angle.copyTo(dst, mask);
}

bool ColorGradientPyramidFull::extractTemplate(Template& templ) const
{
...
ColorGradientFull::ColorGradientFull()
...
ColorGradientFull::ColorGradientFull(float _weak_threshold, size_t _num_features, float _strong_threshold)
  : weak_threshold(_weak_threshold),
    num_features(_num_features),
    strong_threshold(_strong_threshold)
{
...
static const char CGF_NAME[] = "ColorGradientFull";

std::string ColorGradientFull::name() const
{
  return CGF_NAME;
}

Ptr<QuantizedPyramid> ColorGradientFull::processImpl(const Mat& src,
                                                     const Mat& mask) const
{
  return new ColorGradientPyramidFull(src, mask, weak_threshold, num_features, strong_threshold);
}

void ColorGradientFull::read(const FileNode& fn)
{
  std::string type = fn["type"];
  CV_Assert(type == CGF_NAME);
...
void ColorGradientFull::write(FileStorage& fs) const
{
  fs << "type" << CGF_NAME;
...
Ptr<Detector> getFullObjectLINEMOD()
{
  std::vector< Ptr<Modality> > modalities;
  modalities.push_back(new ColorGradientFull);
