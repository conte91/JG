FIND_PATH(eORL_INCLUDE_DIRS NAMES "eORL.h" PATHS /opt/inc /include /usr/include /include/eorl /usr/include/eorl ${eORL_INCLUDE_DIR} DOC "The eORL include directory")
message("eORL_INCLUDE_DIRS: ${eORL_INCLUDE_DIRS}; eORL_LIBRARIES: ${eORL_LIBRARIES}")
message("PREFIX: ${CMAKE_PREFIX_PATH}")
FIND_LIBRARY(eORL_LIBRARIES NAMES "eORL" PATHS /opt/lib /opt/eorl/lib /opt/eORL/lib /usr/lib/eORL /lib/eORL /opt/eORL/ ${CMAKE_PREFIX_PATH}/eORL ${eORL_LIB_DIR} DOC "The eORL library (libeORL.so)")
